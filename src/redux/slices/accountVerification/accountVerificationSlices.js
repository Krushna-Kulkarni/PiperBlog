...
//send Mail Action
export const accVerificationSendTokenAction = createAsyncThunk('account/token', async (email,{ rejectWithValue, getState, dispatch}) => {
    //get user token
...
const accountVerificationSlices = createSlice({name:'account', initialState: {}, extraReducers: (builder) =>{
    //create
